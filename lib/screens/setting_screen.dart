                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            icon:
                                Icon(Icons.access_time, color: greenColor),
                          ),
                          suffixStyle: TextStyle(color: blackColor),
                        ),
                      ...
                      if (_formKey.currentState!.validate()) {
                        if (_weightController.text == '0' ||
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content:
                                  Text('Please weight range from 20-250 kg'),
                            ),
                          );
                        } else {
                          ...
                          if (_wakeTimeController.text !=
                              previousWakeTimeValue) {
                            await storage.write(
                                key: 'wakeTime',
                                value: _wakeTimeController.text);
                            isUserChangeData = true;
                          }
